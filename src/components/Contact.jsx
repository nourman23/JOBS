...
export const Contact = () => {
  return (
    <div className="container mx-auto pt-16 mb-5">
        ...
        <div className="xl:w-3/5 lg:w-3/5 h-full pt-5 pb-5 xl:pr-5 xl:pl-0 rounded-tr rounded-br">
          ...
          >
            ...
            <div className="w-full mt-6">
              ...
              <button
                type="submit"
                className="focus:outline-none transition duration-150 ease-in-out hover:bg-indigo-600 rounded text-white px-8 py-3 text-sm leading-6"
                style={{ backgroundColor: "#1976d2" }}
              >
                Submit
              </button>
